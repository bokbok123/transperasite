...
<nav>
    <div class="nav-wrapper">
        ...
        <ul class="right hide-on-med-and-down" id="menu">
            ...
            <li><a href="https://www.twitter.com/FonebayadPh" target="_blank" style="padding-right: 0;"><img src="{{ Theme::asset()->url('img/icons/twitter.png')}}"></a></li>
            <li><a href="https://www.linkedin.com/company/transpera.com" target="_blank" style="padding-right: 0;"><img src="{{ Theme::asset()->url('img/icons/linkedin.png')}}" style="filter: brightness(0.35) invert(1);"></a></li>
        </ul>
